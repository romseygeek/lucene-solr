 ...
 * </li>
 * 
 * <li> A {@link org.apache.lucene.queries.spans.SpanNearQuery SpanNearQuery} matches spans
 * which occur near one another, and can be used to implement things like
 * phrase search (when constructed from {@link org.apache.lucene.queries.spans.SpanTermQuery}s)
 * and inter-phrase proximity (when constructed from other {@link org.apache.lucene.queries.spans.SpanNearQuery}s).</li>
 *
 ...
 *
 * <li> A {@link org.apache.lucene.queries.spans.SpanContainingQuery SpanContainingQuery} matches spans
 * which contain another spans. </li>
 * 
 * <li>A {@link org.apache.lucene.queries.spans.SpanOrQuery SpanOrQuery} merges spans from a
 * number of other {@link org.apache.lucene.queries.spans.SpanQuery}s.</li>
 * 
 * <li>A {@link org.apache.lucene.queries.spans.SpanNotQuery SpanNotQuery} removes spans
 * matching one {@link org.apache.lucene.queries.spans.SpanQuery SpanQuery} which overlap (or comes
